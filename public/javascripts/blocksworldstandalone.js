...
function handleDrop(event,ui) {
	...
	if ($(ui.helper).hasClass('name')) {
		...
		//UPDATED NAME SYNTAX — DOESN’T WORK YET
		var record = ["Record", { color: ["String", nameColor], shape: ["String", nameShape], x : ["Number", nameX], y : ["Number", nameY]}];
		var decl = "var " + newName + " = " + record;	
