...
var earlyDeadline = new Date(2015, 0, 14, 00, 05, 0).getTime();
      ...
      for(var i = 0; i < earlySubs.length; i++) {
        ...
        for(var i = 0; i < onTimeSubs.length; i++) {
          ...
          if (i < onTimeSubs.length - 1) {
            ...
            var fs = require('fs');
            fs.writeFile("../proofChecker1.csv", gradeStr, function(err) {
              if(err) {
                console.log(err);
              } else {
            ...
            fs.writeFile("../proofChecker1.txt", submissionStr, function(err) {
              if(err) {
                console.log(err);
              } else {
