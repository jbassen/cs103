...
// FIXME: pull "expression data structure" operations into separate module.
...
// This assumes that the set is ordered (by normalizeSet -- which might be buggy).
// pushIfLess means push if arg1[i] < arg2[j],  etc.
// pushIfLess saves members of set1 that are not members of set2.
// pushIfGtr saves members of set2 that are not members of set1.
// pushIfEq saves members that appear in both sets.
...
function evalCall(e, int)
{
    ...
    else if (Array.isArray(efun) && efun[0] === '\\lambda') {
...
var eval1 = {
	...
	if (Array.isArray(e[2]) && e[2][0] === '\\relation') {
    ...
    'comprehension' : 
	function (e) {
	    return normalizeSet(evalComprehension(adjoinReduce, // reduceFcn
					       ["Set"],	    // accumResult
